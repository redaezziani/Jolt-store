        ...
        <div class="flex flex-col justify-between flex-1 mt-6">
            <nav class="-mx-3 space-y-3 ">
                <a href="{{ route('dashboard-index') }}"
                    class="flex items-end px-3 py-2 text-slate-700 font-bold transition-colors duration-300 transform rounded-lg dark:text-amber-300  dark:hover:bg-slate-800 dark:hover:text-slate-200 hover:text-amber-200">
