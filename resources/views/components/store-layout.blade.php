            ...
            <nav id="nav-bar"
                ...
                <div class="flex gap-x-4 justify-center items-center" id="">
                    ...
                    <div
                        ...
                        <livewire:bag-cart />
                        {{-- if auth show user profile --}}
                        @auth
                            <div class="flex justify-start gap-x-2 items-center">

                                <a
                                    class="text-sm font-semibold flex   gap-x-2 justify-start items-center text-slate-50 ">
                                ...
                                {{-- if the users role is admin display the :dashboard-index --}}
                        ...
                        @endauth
                        {{-- if not auth show login --}}
                        @guest
                            <a href="{{ route('login') }}"
                                class="text-sm font-semibold flex ml-6  gap-x-2 justify-start items-center text-slate-50 ">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"
                                    fill="none">
                                    <path d=" M6.57757 15.4816C5.1628 16.324 1.45336 18.0441 3.71266
                                    20.1966C4.81631 21.248 6.04549 22 7.59087 22H16.4091C17.9545 22 19.1837 21.248 20.2873
                                    20.1966C22.5466 18.0441 18.8372 16.324 17.4224 15.4816C14.1048 13.5061 9.89519 13.5061
                                    6.57757 15.4816Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
